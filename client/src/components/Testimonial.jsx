const Testimonial = () => {
    const cardsData = [
        {
            ...
            name: 'Briar Martin',
            handle: '@neilstellar',
            body: "Working with Agnik was a breeze. He delivered high-quality code on time and communicated effectively throughout the project.",
            date: 'April 21, 2025'
        },
        {
            ...
            name: 'Avery Johnson',
            handle: '@averywrites',
            body: "The website Agnik built for my business is both beautiful and functional. He perfectly understood my vision and brought it to life.",
        ...
        },
        {
            ...
            name: 'Jordan Lee',
            handle: '@jordantalks',
            body: "Impressed by the level of professionalism and technical skill. The React app he delivered exceeded our expectations.",
        ...
        },
        {
            ...
            name: 'Avery Johnson',
            handle: '@averywrites',
            body: "Agnik was quick to adapt to changes and offered helpful suggestions that improved the project outcome. Highly recommend!",
        ...
        },
        {
            ...
            name: 'Briar Martin',
            handle: '@neilstellar',
            body: "Agnik was able to troubleshoot and solve complex bugs that others couldn't figure out. Great problem-solving skills.",
            date: 'April 14, 2025'
        },
        {
            image: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200',
            name: 'Avery Johnson',
            handle: '@averywrites',
            body: "Very responsive and always willing to go the extra mile. The final product was polished and delivered ahead of schedule.",
        ...
        },
        {
            ...
            name: 'Jordan Lee',
            handle: '@jordantalks',
            body: "The backend APIs were cleanly written, well-documented, and performed reliably under load. Excellent backend skills.",
        ...
        },
        {
            ...
            name: 'Avery Johnson',
            handle: '@averywrites',
            body: "Agnik's design sense and frontend implementation are top-notch. The site is fast, accessible, and mobile-friendly.",
    ...
    const CreateCard = ({ card }) => {
        ...
        return (
            <div className="card p-4 rounded-lg mx-4 transition-all duration-200 w-72 shrink-0 border border-navy">
                ...
                <p className="text-sm py-4 text-white">{card.body}</p>
                <div className="flex items-center justify-between text-slate-500 text-xs">
                    <div className="flex items-center gap-1">
                        <span>Posted on</span>
                        <a href="https://x.com" target="_blank" className="hover:text-white/80">
    ...
    return (
        ...
        `}</style>
            ...
            <div className="items-start mt-25 md:mt-35 c-space">
                <h2 className="text-heading">Hear from <span className="text-aqua">my clients</span></h2>
                <p className="subtext">Don't just take my word for it. See what my clients have to say. </p>
            </div>
